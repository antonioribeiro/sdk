...
use PragmaRX\SDK\Data\RepositoryManager as DataRepositoryManager;
...
class SDK
{
    ...
    {
	    return $this->config->get('store_cookie_sdk')
    ...
    public function parserIsAvailable()
    {
        ...
        {
            $this->logger->error('SDK: uaparser regex file not available. "Execute php artisan sdk:updateparser" to generate it.');
